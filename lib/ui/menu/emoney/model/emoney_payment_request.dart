class EmoneyPaymentRequest {
  bool? payment;
  String? pin;
  Transaction? transaction;
  String? authToken;

  EmoneyPaymentRequest({this.payment, this.pin, this.transaction, this.authToken});

  EmoneyPaymentRequest.fromJson(Map<String, dynamic> json) {
